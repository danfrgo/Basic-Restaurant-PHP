            ...
            <div class="main-section-title small-10 columns">
                <div class="table">
                    <div class="table-cell">
                        <h1>Bem vindo ao Restaurante Bar</h1>
            ...
            <div class="global-page-container">
                ...
                <div class="reservation-form small-12 columns no-padding">
                    ...
                    <?php
                     ...
                     // Inserir Ficheiros do PHPMailer
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        ...
                        'Mensagem: ' . $mensagem . '<br>' ;
                         ...
                         //Retire o comentário abaixo para verificar os detalhes do envio 
                         // $mail->SMTPDebug = 2;                                

                         // Usar SMTP para o envio
                         $mail->isSMTP();                                      

                         // Detalhes do servidor (vou utilizar o Google)
